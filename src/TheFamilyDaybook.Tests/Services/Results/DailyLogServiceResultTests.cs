...
[TestFixture]
public class DailyLogServiceResultTests
{
    [Test]
    public void Success_WithMessage_ReturnsSuccessResult()
    {
        ...
        // Act
        var result = DailyLogServiceResult.Success(message);
    ...
    {
        // Act
        var result = DailyLogServiceResult.Success();
    ...
    public void Failure_WithErrorMessage_ReturnsFailureResult()
    {
        ...
        // Act
        var result = DailyLogServiceResult.Failure(errorMessage);
