...
[TestFixture]
public class AccountServiceResultTests
{
    [Test]
    public void Success_WithMessage_ReturnsSuccessResult()
    {
        ...
        // Act
        var result = AccountServiceResult.Success(message);
    ...
    {
        // Act
        var result = AccountServiceResult.Success();
    ...
    public void Failure_WithErrorMessage_ReturnsFailureResult()
    {
        ...
        // Act
        var result = AccountServiceResult.Failure(errorMessage);
