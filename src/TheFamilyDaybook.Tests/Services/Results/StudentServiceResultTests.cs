...
[TestFixture]
public class StudentServiceResultTests
{
    [Test]
    public void Success_WithMessage_ReturnsSuccessResult()
    {
        ...
        // Act
        var result = StudentServiceResult.Success(message);
    ...
    {
        // Act
        var result = StudentServiceResult.Success();
    ...
    public void Failure_WithErrorMessage_ReturnsFailureResult()
    {
        ...
        // Act
        var result = StudentServiceResult.Failure(errorMessage);
